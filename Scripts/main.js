    ...
    provideIssues(editor) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (!editor.document.isRemote && typeof editor.document.path === "string") {
                let runFromFileFolder = nova.workspace.config.get("pro.albright.luacheck.run-from-file-folder");
                if (runFromFileFolder == false) {
                    ...
                    // luacheck to check for configuration files in its ordinary way.
